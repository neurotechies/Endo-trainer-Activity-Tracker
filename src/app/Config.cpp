...
int Config::init(int argc, char **argv)
{
    ...
    if(!m_configPath.empty())
    {
		...
		// extra entries
		m_cfg.lookupValue("PEGBOUNDINGBOX_X", m_settings.PEGBOUNDINGBOX_X);
		m_cfg.lookupValue("PEGBOUNDINGBOX_Y", m_settings.PEGBOUNDINGBOX_Y);
		m_cfg.lookupValue("PEGBOUNDINGBOX_WIDTH", m_settings.PEGBOUNDINGBOX_WIDTH);
		m_cfg.lookupValue("PEGBOUNDINGBOX_HEIGHT", m_settings.PEGBOUNDINGBOX_HEIGHT);
		m_cfg.lookupValue("PEGSATURATION_MINVALUE", m_settings.PEGSATURATION_MINVALUE);
		m_cfg.lookupValue("MIN_PEG_SIZE", m_settings.MIN_PEG_SIZE);
		m_cfg.lookupValue("HUE_THRESHVAL_RING", m_settings.HUE_THRESHVAL_RING);
		m_cfg.lookupValue("STABLE_COUNT", m_settings.STABLE_COUNT);
		m_cfg.lookupValue("TLD_WITH_TRACKER_ONLY", m_settings.TLD_WITH_TRACKER_ONLY);
		m_cfg.lookupValue("STATIONARY_FRAME_COUNT", m_settings.STATIONARY_FRAME_COUNT);
		m_cfg.lookupValue("CONSECUTIVE_FRAME_COUNT", m_settings.CONSECUTIVE_FRAME_COUNT);
		m_cfg.lookupValue("NO_OF_IMAGES_HITTING_DETECTION", m_settings.NO_OF_IMAGES_HITTING_DETECTION);
		m_cfg.lookupValue("HITTING_THRESHOLD", m_settings.HITTING_THRESHOLD);
...
int Config::configure(Main *main)
{
	...
	// extra entries
	main->PEGBOUNDINGBOX_X = m_settings.PEGBOUNDINGBOX_X;
	main->PEGBOUNDINGBOX_Y = m_settings.PEGBOUNDINGBOX_Y;
	main->PEGBOUNDINGBOX_WIDTH = m_settings.PEGBOUNDINGBOX_WIDTH;
	main->PEGBOUNDINGBOX_HEIGHT = m_settings.PEGBOUNDINGBOX_HEIGHT;
	main->PEGSATURATION_MINVALUE = m_settings.PEGSATURATION_MINVALUE;
	main->MIN_PEG_SIZE = m_settings.MIN_PEG_SIZE;
	main->HUE_THRESHVAL_RING = m_settings.HUE_THRESHVAL_RING;
	main->STABLE_COUNT = m_settings.STABLE_COUNT;
	main->TLD_WITH_TRACKER_ONLY = m_settings.TLD_WITH_TRACKER_ONLY;
	main->STATIONARY_FRAME_COUNT = m_settings.STATIONARY_FRAME_COUNT;
	main->CONSECUTIVE_FRAME_COUNT = m_settings.CONSECUTIVE_FRAME_COUNT;
	main->NO_OF_IMAGES_HITTING_DETECTION = m_settings.NO_OF_IMAGES_HITTING_DETECTION;
	main->HITTING_THRESHOLD = m_settings.HITTING_THRESHOLD;
